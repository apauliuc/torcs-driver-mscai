...
class Client():
    def __init__(self, H=None, p=None, i=None, e=None, t=None, s=None, d=None, f=None, X=None):
    ...
    def parse_the_command_line(self):
        try:
            (opts, args) = getopt.getopt(sys.argv[1:], 'f:H:X:p:i:m:e:t:s:dhv',
                                         ['host=', 'difficulty=', 'port=', 'id=', 'steps=',
        ...
        try:
            for opt in opts:
                ...
                if opt[0] == '-H' or opt[0] == '--host':
                    self.host = opt[1]
                if opt[0] == '-X' or opt[0] == '--difficulty':
                    self.trial = opt[1]
