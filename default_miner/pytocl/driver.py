...
class Driver:
    ...
    def __init__(self, difficulty=None, logdata=True):
        self.difficulty = difficulty
        file_path = 'data/{}/race_{}.csv'.format(self.difficulty, ''.join(random.choice(string.ascii_uppercase) for i in range(4)))
    ...
    def drive(self, carstate: State) -> Command:
        ...
        # State: [speedX, angle, distanceFromCenter, *sensorValues]
